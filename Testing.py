...
plt.subplot(1, 2, 1)
plt.plot(range(1, epochs + 2), train_losses, label="Train loss")
plt.plot(range(1, epochs + 2), test_losses, label="Test loss")
plt.xlabel("Epoch")
...
plt.style.use('dark_background')
plt.subplot(1, 2, 2)
plt.plot(range(1, epochs + 2), train_accuracies, label="Train accuracy")
plt.plot(range(1, epochs + 2), test_accuracies, label="Test accuracy")
plt.xlabel("Epoch")
plt.ylabel("Accuracy")
